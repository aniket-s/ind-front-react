                    ...
                    {visibleProducts.map((model) => (
                        <div key={model.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300">
                            ...
                            {model.id === currentProduct.id && (
                                <div className="bg-gradient-to-r from-[#e1a038] via-[#efdd71] via-[#f7f0aa] via-[#ebda73] to-[#f7d89f] text-gray-800 text-center py-2 font-semibold text-sm">
                                    Currently Viewing
                                </div>
                            )}
                            ...
                            <div className="p-4 md:p-6">
                                ...
                                {model.id === currentProduct.id ? (
                                    ...
                                    <Link
                                        ...
                                        className="block w-full bg-gradient-to-r from-[#e1a038] via-[#efdd71] via-[#f7f0aa] via-[#ebda73] to-[#f7d89f] text-gray-800 py-3 rounded-full font-semibold hover:bg-yellow-300 transition text-center"
                                    >
                                        View Details
                                    </Link>
                                )}
